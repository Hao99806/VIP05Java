...
public class Dog {
	...
	public String littleDogVoice="呜呜";
	public String bigDogVoice="汪汪";
	public String oldDogVoice="嗷嗷";
	...
	public Dog(int a,String dogName) {
		
	}
	
	public Dog(int a,int dogName) {
...
//		System.out.println(i);
		if (age < 3) {
			System.out.println("小" + name + "正在对着" + people + littleDogVoice);
			grow(2);
		} else {
			if (age < 6) {
				System.out.println("大" + name + "正在对着" + people + bigDogVoice);
				grow(3);
			} else {
				System.out.println("老" + name + "正在对着" + people + oldDogVoice);
				grow(3);
			}
		}
	}
...
//		bark("roy");
	...
	public void  grow(int growAge) {
		float f= grow(1.5f);
		age+=growAge;
		System.out.println(name+"长大了"+growAge+"岁,现在"+age+"岁");
	}
...
//	}
	...
	//静态修饰符也不影响方法重载
//	public static double grow() {
//		
//	}
	
	public float grow(float growAge) {
		age+=growAge;
		return age;
	}
